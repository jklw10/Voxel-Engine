...
namespace Voxel_Engine.GUI
{
    ...
    public class ImGuiController : IDisposable
    {
        ...
        public ImGuiController(int width, int height)
        {
            ...
            _ = _shader ?? throw new ApplicationException("shader creation failed");
            _ = _fontTexture ?? throw new ApplicationException("font creation failed");
...
void main()
{
    outputColor = color * texture(in_fontTexture, texCoord);
        ...
        private void UpdateImGuiInput(GameWindow wnd)
        {
            ...
            foreach (Keys key in (IEnumerable<Keys>)Enum.GetValues(typeof(Keys)))
            {
                ...
                //io.Keys[(int)key] = KeyboardState.IsKeyDown(key);
            }
